...
<head>
  ...
  <title>List Service | Dashboard</title>
  <?php 
       ...
       <div class="box">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                    ...
                    <td><a class='btn btn-primary' href="edit-service.php?id=<?php echo $row['id']; ?>"><i class='fa fa-fw fa-pencil-square'></i></a>
                    <a class='btn btn-danger' onclick='return myfunction();' href="delete-service.php?id=<?php echo $row['id']; ?>"><i class='fa fa-fw fa-trash'></i></a>
                </td>
                    </tr>
                <?php } ?>
