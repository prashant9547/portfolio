...
$res = $database->createEdu($eduName,$eduStart,$eduEnd,$eduDesc); 
if($res){
    echo "<script>alert('Add Education Successfully.');window.location.href='list-edu.php';</script>";
    }
}
?>
            ...
            <form role="form" method='POST' enctype='multipart/form-data'>
              <div class="box-body">
                <div class="form-group">
                  <label for="cName">Name Of Education</label>
                  <input type="text" class="form-control" id="cName" name='cName' placeholder="Enter Education Name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="editor1"> Education Description</label>
