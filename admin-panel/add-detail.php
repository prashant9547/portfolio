...
if(isset($_POST['addSubmit'])){
    if(isset($_FILES["logoDetail"]) && $_FILES["logoDetail"]["error"] == 0){
        ...
        echo "Error: " . $_FILES["logoDetail"]["error"];
    }
        $nameDetail = $_POST['nameDetail'];
        $logoDetail = $filename;
        $myDetail = $_POST['editor1'];
    
        $res = $database->createDetail($logoDetail,$nameDetail,$myDetail); 
        if($res){
            echo "<script>alert('Add You'r Detail Successfully.');window.location.href='list-detail.php';</script>";
        }
}
?>
            ...
            <form role="form" method='POST' enctype='multipart/form-data'>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nameDetail" name='nameDetail' placeholder="Enter Detail Name">
                </div>
                <div class="form-group">
                  <label for="logoDetail">Logo</label>
                  <input type="file" class="form-control" id="logoDetail" name='logoDetail'>
                </div>
                <div class="form-group">
                  <label for="editor1">Description</label>
                  <textarea name="editor1" id="editor1" rows="10" cols="70" placeholder="Enter Description"></textarea>
            <script>
