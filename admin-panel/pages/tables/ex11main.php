...
if(isset($_POST['submit']))
{
   ...
   echo $sql = "INSERT INTO user(u_name,u_email,u_password,u_rights) VALUES('".$_POST['uname']."','".$_POST["email"]."','".$password."','".$rights1."')";
        ...
        <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form onsubmit="validateForm()" name="f1" id="f1" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" class="icheckbox_flat-green" id="checkbox" name="checkbox[]" value="All Rights">All Rights<br/>
                  <input type="checkbox" class="icheckbox_flat-green" id="checkbox" name="checkbox[]" value="Read only">Read only<br/>
                  <input type="checkbox" class="icheckbox_flat-green" id="checkbox" name="checkbox[]" value="Write only">Write only<br/>
                  <input type="checkbox" class="icheckbox_flat-green" id="checkbox" name="checkbox[]" value="View Only">View Only<br/>
                </div>            
              </div>
 ...
 var uname = document.forms["f1"]["uname"].value;
		 var email = document.forms["f1"]["email"].value;
		  ...
		  var cpassword = document.forms["f1"]["cpassword"].value;
		   var rights = document.forms["f1"]["checkbox"].value;
		    
 if (uname == "" || email == ""|| password == "" || cpassword == "" || rights != "checked"  ) {
