...
{
     $sql = "INSERT INTO country1(country) VALUES('".$_POST['cname']."')";
            ...
            <div class="form-group">
              <label>Select Country</label>
                  ...
                  <?php
                                                ...
                                                {
					                                echo "<option value='".$country['c_id']."'>".$country['country']."</option>";
				                                }
			                                ?>
                  </select>
                  <br/>
              ...
              <label>Select State</label>
                  ...
                  <?php
				                                ...
				                                $sql = "SELECT * FROM state1 ORDER BY country";
				                                $result = mysqli_query($con,$sql);
              ...
              <label>Select City</label>
                  ...
                  <?php
				                                ...
				                                $sql = "SELECT * FROM city1 ORDER BY country";
				                                $result = mysqli_query($con,$sql);
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Country Detail</h4>
              </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="uname"> Add Country Name :</label>
                  <input type="text" class="form-control" id="cname" name="cname" placeholder="Enter Country Name" required/>
                </div>
