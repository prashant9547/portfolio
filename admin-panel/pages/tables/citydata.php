...
{
   echo $sql = "INSERT INTO city1(c_id,s_id,city) VALUES('".$_POST['country']."','".$_POST['state']."','".$_POST['ciname']."')";
          ...
          <div class="modal-dialog">
            ...
            <div class="form-group">
              <label>Select state</label>
	                                <select class="form-control" name="state" id="state">
	                                    <option value="0">Select State</option>	
                                          <?php
				                                ...
				                                $sql = "SELECT * FROM state1 ORDER BY state";
				                                $result = mysqli_query($con,$sql);
                  ...
                  <br/>
                <div class="form-group">
                  <label for="ciname"> Add city Name :</label>
                  <input type="text" class="form-control" id="ciname" name="ciname" placeholder="Enter City Name" required/>
                </div>
