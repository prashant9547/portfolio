    ...
    var getPoster = function(){
         ...
         var film = $('#term').val();
          ...
          if(film == ''){
             ...
             $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/f3efd84c33ac6aa4eddc69e63413ce3f" + film + "?callback=?", function(json) {
                if (json != "Nothing found."){
                      ...
                      $.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/f3efd84c33ac6aa4eddc69e63413ce3f/goonies?callback=?", function(json) {
                         console.log(json);
