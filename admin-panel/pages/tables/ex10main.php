...
if(isset($_POST['submit']))
{
    ...
    $nofmem1 = implode("-", $_POST["nofmem"]);
    $nofper1 = implode("-", $_POST["nofper"]);
    $password = md5($_POST["password"]);

    /*$sql = 'INSERT INTO info(u_name,u_email,u_password,u_mem,u_per,u_url)VALUES("'.$_POST["fname"].'","'.$_POST["email"].'","'.$password.'","'.$nofmem1.'","'.$nofper1.'","'.$_POST["url"].'")';*/
    $sql = "INSERT INTO info(u_name,u_email,u_password,u_mem,u_per,u_url) VALUES('".$_POST['uname']."','".$_POST["email"]."','".$password."','".$nofmem1."','".$nofper1."','".$_POST['url']."')";
...
<div class="wrapper">
  ...
  <div class="col-md-6">
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form onsubmit="validateForm()" id="f1" name="f1" method="post" enctype="multipart/">
              <div class="box-body">
                ...
                <div class="form-group" id="div_box">
                  <div class="div_row" id="row_01">
                     <input type="number" class="form-control" id="nofmem" name="nofmem[]" placeholder="Enter No of Member" min="1" max="100">
                     <input type="number" class="form-control" id="nofper" name="nofper[]" placeholder="Enter No of Percentag" min="1" max="100">
                     <button type="button" class="button-new btn btn-success" value="new" onclick="NewRow(this)">New</button>
                    <button type="button" class="button-delete btn btn-danger" style="display: none;" value="new" onclick="DeleteRow(this)">Delete</button>
                  </div>
                </div>
...
<script>
    ...
    function validateForm() {
      ...
      var url = document.forms["f1"]["url"].value;
		  var nofmem = document.forms["f1"]["nofmem"].value;
      var nofper = document.forms["f1"]["nofper"].value;
		    
 if (uname == "" || email == ""|| password== "" || cpassword == "" || url == "" || nofmem == "" || nofper == "" ) {
