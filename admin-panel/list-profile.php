  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List profile</li>
      </ol>
    </section>
       ...
       <div class="box">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                    ...
                    <td><a class='btn btn-primary' href="edit-profile.php?id=<?php echo $row['id']; ?>"><i class='fa fa-fw fa-pencil-square'></i></a>
                    <a class='btn btn-danger' onclick='return myfunction();' href="delete-profile.php?id=<?php echo $row['id']; ?>"><i class='fa fa-fw fa-trash'></i></a>
                </td>
                    </tr>
                <?php } ?>
                <tfoot>
