...
if(isset($_POST['addSubmit'])){
    if(isset($_FILES["profileImg"]) && $_FILES["profileImg"]["error"] == 0){
        ...
        echo "Error: " . $_FILES["profileImg"]["error"];
    }
    
    $profileImg = $filename;
    $res = $database->createProfile($profileImg); 
    if($res){
        echo "<script>alert('Add Profile Successfully.');window.location.href='list-profile.php';</script>";
    }
}
?>
